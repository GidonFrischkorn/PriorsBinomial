...
if (!dir.exists(results_dir)) {
  ...
  for (i in seq_len(n_conditions)) {
    cond_file <- file.path(results_dir, paste0("BFCalib_RE_Cond-", i, ".rds"))
  ...
  saveRDS(posteriors, here("output", "bf_calibration_re_posteriors.rds"))
  message("Saved: output/bf_calibration_re_posteriors.rds  (",
